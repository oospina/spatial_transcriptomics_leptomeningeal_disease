...
gene_sets = filter(gene_sets, gs_subcat == "GO:BP") %>% 
...
# Write test results
openxlsx::write.xlsx(pval_dfs, paste0(tissue, '_minspots_', as.character(min_units), '_sd_', as.character(num_sds),'_go_pathway_tests.xlsx'))
